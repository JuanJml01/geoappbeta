    ...
    return Scaffold(
      ...
      body: Consumer<Reporteprovider>(
        builder: (context, reporteProvider, child) {
          List<Reporte> reportes = reporteProvider.reportes;
          // Aplicar filtros
          if (filtroTipo != null && filtroTipo!.isNotEmpty) {
            reportes = reportes.where((r) => tipoReporteToString(r.tipo) == filtroTipo).toList();
          }
          if (filtroEstado != null && filtroEstado!.isNotEmpty) {
            reportes = reportes.where((r) => estadoReporteToString(r.estado) == filtroEstado).toList();
          }
          if (filtroFecha != null) {
